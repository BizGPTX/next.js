...
- [Electrician GPT](/docs/community/electrician-gpt): An agent blueprint that helps Australian electrical professionals research award wages, stay compliant with safety regulations, estimate jobs, and answer code-related questions.
